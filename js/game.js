document.addEventListener("DOMContentLoaded", () => {
    ...
    function valley() {
        ...
        ctx.beginPath();
        ctx.moveTo(0, 350);
        ctx.bezierCurveTo(100, 330, 200, 360, 300, 340);
        ctx.bezierCurveTo(400, 320, 500, 350, 600, 330);
    ...
    function drawHouse(x, y, w, h) {
        ...
        // Door
        ctx.fillStyle = "#331";
        ctx.fillRect(x + w/3, y + h/2, w/4, h/2);
    }
    ...
    // VISUAL SCENES
    // =========================
    const scene1Visual=()=>{clearScene();valley();drawStick(100,260,"#4ac"); drawStick(160,260,"#6f4"); drawHouse(300,280,60,60);}
    const scene2Visual=()=>{clearScene();valley();drawStick(100,260,"#4ac"); drawStick(160,260,"#b85"); drawHouse(260,285,70,60);}
    const npc3Visual  =()=>{clearScene();valley();drawStick(100,260,"#4ac"); drawStick(150,260,"#e96");}
